...
### Dependencies
- Bump `@mantine/core` from 7.15.1 to 7.17.1 ([#59](https://github.com/DeFlanko/UniversalMediaServer/pull/59))
- Bump `@mantine/dropzone` from 7.15.1 to 7.17.1 ([#59](https://github.com/DeFlanko/UniversalMediaServer/pull/59))
- Bump `@mantine/form` from 7.15.1 to 7.17.1 ([#59](https://github.com/DeFlanko/UniversalMediaServer/pull/59))
- Bump `@mantine/hooks` from 7.15.1 to 7.17.1 ([#59](https://github.com/DeFlanko/UniversalMediaServer/pull/59))
- Bump `@mantine/modals` from 7.15.1 to 7.17.1 ([#59](https://github.com/DeFlanko/UniversalMediaServer/pull/59))
- Bump `@mantine/notifications` from 7.15.1 to 7.17.1 ([#59](https://github.com/DeFlanko/UniversalMediaServer/pull/59))
