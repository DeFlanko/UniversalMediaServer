...
### Dependencies
- Bump `@mantine/core` from 7.15.1 to 7.17.0 ([#57](https://github.com/DeFlanko/UniversalMediaServer/pull/57))
- Bump `@mantine/dropzone` from 7.15.1 to 7.17.0 ([#57](https://github.com/DeFlanko/UniversalMediaServer/pull/57))
- Bump `@mantine/form` from 7.15.1 to 7.17.0 ([#57](https://github.com/DeFlanko/UniversalMediaServer/pull/57))
- Bump `@mantine/hooks` from 7.15.1 to 7.17.0 ([#57](https://github.com/DeFlanko/UniversalMediaServer/pull/57))
- Bump `@mantine/modals` from 7.15.1 to 7.17.0 ([#57](https://github.com/DeFlanko/UniversalMediaServer/pull/57))
- Bump `@mantine/notifications` from 7.15.1 to 7.17.0 ([#57](https://github.com/DeFlanko/UniversalMediaServer/pull/57))
