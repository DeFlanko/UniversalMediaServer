...
### Dependencies
- Bump `@mantine/core` from 7.15.1 to 7.16.2 ([#55](https://github.com/DeFlanko/UniversalMediaServer/pull/55))
- Bump `@mantine/dropzone` from 7.15.1 to 7.16.2 ([#55](https://github.com/DeFlanko/UniversalMediaServer/pull/55))
- Bump `@mantine/form` from 7.15.1 to 7.16.2 ([#55](https://github.com/DeFlanko/UniversalMediaServer/pull/55))
- Bump `@mantine/hooks` from 7.15.1 to 7.16.2 ([#55](https://github.com/DeFlanko/UniversalMediaServer/pull/55))
- Bump `@mantine/modals` from 7.15.1 to 7.16.2 ([#55](https://github.com/DeFlanko/UniversalMediaServer/pull/55))
- Bump `@mantine/notifications` from 7.15.1 to 7.16.2 ([#55](https://github.com/DeFlanko/UniversalMediaServer/pull/55))
